...
# 📖 [Wizzy-news] <a name="about-project"></a>

<!-- > Describe your project in 1 or 2 sentences. -->

**[Wizzy-news]** is a Front end template build with Html css and Javascript to Show a list of blog post that can be used to show content about News or other type of content.
...
- [Wizzy Beauty Link](https://wizzy-news.netlify.app/)
...
```
  cd my-folder
  git clone git@github.com:desorgui/wizzy-news.git
  cd wizzy-news
```
